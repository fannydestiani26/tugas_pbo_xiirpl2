...
<table border="1">
    <tr>
        <td>NISN</td>
        <td><input required type="number" name="nisn" placeholder="HARAP ISI NISN !!"></td>
    </tr>
    <tr>
        <td>NIS</td>
        <td><input required type="number" name="nis"></td>
    </tr> 
    <tr>
        <td>Nama</td>
        <td><input required type="text" name="nama"  onkeypress="return event.charCode < 48 || event.charCode  >57"></td>
    </tr>
    <tr>
        <td>Kelas</td>
    ...
    <tr>
        <td>No Telepon</td>
        <td><input required type="number" name="id_telp"></td>
    <tr>
            <td>Nominal SPP</td>
